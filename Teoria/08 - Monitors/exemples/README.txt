-------------------------
Exemples amb un deadlock
-------------------------

* Executar fitxer deadlock.c. Observar que es bloqueja l'aplicació perquè 
  s'agafen dos cops la clau.

* Executar exemple dels filosofs.c. En aquest codi els filosofs comencen
  per agafar la forquilla de l'esquerra i després la de la dreta. En algun
  moment de l'excució es produirà un deadlock. Podeu arreglar el codi perquè 
...
* Executar genera_fitxer.c. Aixo permet generar fitxer.data per fer proves amb 
  l'executable lectura_fitxer.c

* Executar lectura_fitxer.c. Observar que amb 1 fil es llegeixen tantes linies
